...
| Test  | mdz_xml<br>parse()<br>memory | mdz_xml<br>parse()<br>speed | mdz_xml<br>parseWritable()<br>memory | mdz_xml<br>parseWritable()<br>speed | Rapid<br>XML|Tiny<br>XML<br>2|MS<br>XML<br>6.0|pugi<br>Xml|
| :---: | ---:            | ---:          | ---:                    | ---:                  | ---:     | ---:    |---:     |---:   |
| **800 MB**| |||||
