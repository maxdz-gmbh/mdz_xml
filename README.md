...
| Test  | mdz_xml_parse() | mdz_xml_parseWritable() | Rapid-XML|TinyXML-2|MSXML 6.0|pugiXml|
| :---: | ---:               | ---:                        | ---:       | ---:           | ---:            | ---:    |
| **800 MB**|                |                             |            |                 |            |          |
...
| Test<br>speed, μs  | mdz_xml_parseFile() | Rapid-XML|TinyXML-2|MSXML 6.0|pugiXml|
| :---:              | ---:                    | ---:      | ---:    | ---:    | ---: |
